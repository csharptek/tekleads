...
const KEYS = {
  ...
  WhatsappCloudWabaId: "whatsapp_cloud_waba_id",
...
const USER_GROUPS: Group[] = [
  ...
  {
    title: "WhatsApp (wa.me Deep Link)",
    subtitle: "Quick outreach via wa.me. Use {name} and {phone} as variables. Best for manual one-off sends.",
    fields: [
  ...
  },
  {
    ...
    subtitle: "Send via Meta Cloud API for scale, delivery tracking, and no number blocking. Requires approved templates for cold outreach.",
    fields: [
      { key: KEYS.WhatsappCloudPhoneNumberId, label: "Phone Number ID", placeholder: "From Meta → API Setup", full: true },
      { key: KEYS.WhatsappCloudWabaId, label: "WhatsApp Business Account ID", placeholder: "From Meta → API Setup", full: true },
      { key: KEYS.WhatsappCloudAccessToken, label: "Access Token", placeholder: "System User permanent token", secret: true, full: true },
      { key: KEYS.WhatsappCloudVerifyToken, label: "Webhook Verify Token", placeholder: "Any random string you set in Meta", secret: true },
